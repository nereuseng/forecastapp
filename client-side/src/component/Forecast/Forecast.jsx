<<<<<<< HEAD:client-side/src/component/Forecast/Forecast.jsx
...
import {connect} from 'react-redux';
import {getForecast, getLocationWeather, getUserLocation} from 'states/weather-actions.js';
...
class Forecast extends Component {
    ...
    // }
    handleClick(lat, lng){
        this.props.dispatch(getLocationWeather(lat, lng, this.props.unit));
    }
    ...
    handleUserLocation(){
        ...
        this.props.dispatch(getUserLocation(this.props.unit));
        // getUserLocation().then(userCoords => {
        //     this.setState ({
        //         lat: userCoords.coords.latitude,
        //         lng: userCoords.coords.longitude
...
>>>>>>> dba765455248190ce58d2a68b6fc9050674c49b3:src/component/Forecast/Forecast.jsx
})(Forecast);